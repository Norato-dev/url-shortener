  ...
  return (
    <main className="min-h-screen flex flex-col" style={{ backgroundColor: '#f0edf8' }}>
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-5">
        ...
        <a href="/dashboard" className="text-sm px-4 py-2 rounded-lg transition-colors"
      ...
      <div className="relative z-10 flex flex-1 items-center px-8 max-w-6xl mx-auto w-full gap-16">

        {/* Left: Text */}
        <div className="flex-1">
          <p className="text-lg font-medium mb-3" style={{ color: '#7c3aed' }}>
            // url shortener
          </p>
          <h1 className="text-5xl font-bold leading-tight mb-4" style={{ color: '#2d1b5e' }}>
            Links cortos,<br />impacto grande.
          </h1>
          <p className="text-lg mb-8" style={{ color: '#8b7aaa', lineHeight: 1.7 }}>
            ...
            {tab === 'custom' && (
              <div className="mb-3">
                ...
                <div className="flex items-center rounded-lg overflow-hidden" style={{ border: '1.5px solid #d4c9ee' }}>
                  <span className="px-3 py-2.5 text-sm" style={{ backgroundColor: '#f0edf8', color: '#a99bc0' }}>
                    localhost:3000/
                  </span>
                  <input
                    type="text"
